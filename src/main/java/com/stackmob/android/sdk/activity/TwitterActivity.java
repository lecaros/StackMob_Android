...
public class TwitterActivity extends Activity {
	...
	if (TwitterCallback != null) {
	    if (failure != null) {
		TwitterCallback.failure(new StackMobException(failure
			.getMessage()));
	    }
	...
	protected void onPostExecute(Void result) {
	    ...
	    setTwitterTokens(consumer.getToken(), consumer.getTokenSecret(),
		    null);
	    finish();
	}
    }
	...
	try {
	    consumer = new CommonsHttpOAuthConsumer(TWITTER_CONSUMER_KEY,
